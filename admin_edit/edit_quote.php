...
<main class="edit-main">
 ...
 JOIN quote q ON jp.id = q.section_id
 WHERE jp.page_num = ? AND jp.order_num = ?;";
    ...
    <form class="edit-form" method="post"
        action="../includes/edit_update/update_quote.php?page_num=<?php echo $page_num ?>&order_num=<?php echo $order_num ?>">
        <div class="edit-form-content">
            <h2>Edit Text</h2>
            <textarea name="quote_content" id="quote_input" class="edit-input" placeholder="Please Enter Text"
                rows="7" value=""><?php echo $row["quote_content"] ?></textarea>
