...
<main class="edit-main">
 ...
 LEFT JOIN text t ON jp.id = t.section_id
 WHERE jp.page_num = ? AND jp.order_num = ?;";
    ...
    <form class="edit-form" method="post"
        action="../includes/edit_update/update_text.php?page_num=<?php echo $page_num ?>&order_num=<?php echo $order_num ?>">
        <div class="edit-form-content">
            <h2>Edit Text</h2>
            <textarea name="text_content" id="text_input" class="edit-input" placeholder="Please Enter Text"
                rows="7" value=""><?php echo $row["text_content"] ?></textarea>
